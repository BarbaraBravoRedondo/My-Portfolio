...
const Diplomas = () => {
  ...
  return (
    <div className="swiper-container">
      ...
      >
        <SwiperSlide>
          <img className='PicSlideD' src={Certificate1} alt="Miniatura Certificación 1" />
        </SwiperSlide>
        <SwiperSlide>
          <img className='PicSlideD' src={Certificate2} alt="Miniatura Certificación 2" />
        </SwiperSlide>
        <SwiperSlide>
          <img className='PicSlideD' src={Certificate3} alt="Miniatura Certificación 3" />
        </SwiperSlide>
        <SwiperSlide>
          <img className='PicSlideD' src={Certificate4} alt="Miniatura Certificación 4" />
        </SwiperSlide>
      </Swiper>
    </div>
  );
